                ...
                if state[i][0]!="":
                        if ":" in state[i][0]:
                                if (state[i][1]=="mov" and "$" in state[i][3]) and state[i][2]=="FLAGS":
                                        ...
                                        print("Error at line",indata.index(state[i])+1,"Illegal use of flag registers")
                                        quit()
                                elif state[i][1] in typeB and state[i][2]=="FLAGS" and state[i][1]!="FLAGS" and state[i][1]!='mov':
                                        print("Error at line",indata.index(state[i])+1,"Illegal use of flag registers")
                                        quit()
                                ...
                                if (state[i][0]=="mov" and "$" in state[i][2]) and state[i][1]=="FLAGS":
                                        ...
                                        print("Error at line",indata.index(state[i])+1,"Illegal use of flag registers")
                                        quit()
                                elif state[i][0] in typeB and state[i][1]=="FLAGS" and state[i][2]!="FLAGS" and state[i][0]!='mov':
                                        print("Error at line",indata.index(state[i])+1,"Illegal use of flag registers")
                                        quit()
